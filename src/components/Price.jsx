          ...
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
            <div className="p-10 border border-neutral-700 rounded-xl">
              <p className="text-4xl mb-8">
                ...
                {option.title === "Pro" && (
                  <span
                    className="bg-gradient-to-r from-orange-500 to-red-400 bg-clip-text text-transparent 
                        mb-4 ml-2 text-xl"
                  >
                    {" "}
                    (Most Popular)
              ...
              <a
                ...
                className="inline-flex justify-center items-center text-center
                    w-full h-12 p-5 mt-20 tracking-tight text-xl hover:bg-orange-500 
                    border border-orange-900 rounded-3xl transition duration-200 "
              >Subscribe</a>
            </div>
          </div>
        ))}
